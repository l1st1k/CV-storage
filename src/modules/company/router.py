...
class CompanyRouter:
    ...
    @staticmethod
    async def update_company(model: CompanyUpdate, Authorize: AuthJWT = Depends()) -> JSONResponse:
        return CompanyRepository.update(updated_model=model, Authorize=Authorize)
